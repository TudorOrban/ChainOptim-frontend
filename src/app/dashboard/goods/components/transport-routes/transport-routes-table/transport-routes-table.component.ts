...
@Component({
    selector: 'app-transport-routes-table',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    templateUrl: './transport-routes-table.component.html',
    styleUrl: './transport-routes-table.component.css',
})
export class TransportRoutesTableComponent implements OnInit {
